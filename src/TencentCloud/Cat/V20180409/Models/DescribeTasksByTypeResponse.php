 ...
 *
 * @method integer getTotalCount() 获取符合条件的总任务数
 * @method void setTotalCount(integer $TotalCount) 设置符合条件的总任务数
...
class DescribeTasksByTypeResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 符合条件的总任务数
