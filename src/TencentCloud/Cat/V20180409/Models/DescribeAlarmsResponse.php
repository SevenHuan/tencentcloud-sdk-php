 ...
 *
 * @method integer getTotalCount() 获取告警总条数
 * @method void setTotalCount(integer $TotalCount) 设置告警总条数
 * @method array getAlarmInfos() 获取本批告警信息列表
 * @method void setAlarmInfos(array $AlarmInfos) 设置本批告警信息列表
...
class DescribeAlarmsResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 告警总条数
     * @param array $AlarmInfos 本批告警信息列表
