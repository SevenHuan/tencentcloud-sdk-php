 ...
 */
namespace Hdgtxcloud\Msp\V20180319\Models;
 ...
 * @method integer getTotalCount() 获取项目总数
 * @method void setTotalCount(integer $TotalCount) 设置项目总数
