 ...
 *
 * @method Quota getUrlPurge() 获取Url刷新用量及配额。
 * @method void setUrlPurge(Quota $UrlPurge) 设置Url刷新用量及配额。
 * @method Quota getPathPurge() 获取目录刷新用量及配额。
 * @method void setPathPurge(Quota $PathPurge) 设置目录刷新用量及配额。
...
class DescribePurgeQuotaResponse extends AbstractModel
{
    ...
    /**
     * @param Quota $UrlPurge Url刷新用量及配额。
     * @param Quota $PathPurge 目录刷新用量及配额。
