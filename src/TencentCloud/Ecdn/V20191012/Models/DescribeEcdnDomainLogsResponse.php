 ...
 *
 * @method array getDomainLogs() 获取日志链接列表。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setDomainLogs(array $DomainLogs) 设置日志链接列表。
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getTotalCount() 获取日志链接总条数。
 * @method void setTotalCount(integer $TotalCount) 设置日志链接总条数。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $DomainLogs 日志链接列表。
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $TotalCount 日志链接总条数。
