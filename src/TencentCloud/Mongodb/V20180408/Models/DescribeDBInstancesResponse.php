 ...
 * @method array getInstanceDetails() 获取实例详细信息
 * @method void setInstanceDetails(array $InstanceDetails) 设置实例详细信息
...
class DescribeDBInstancesResponse extends AbstractModel
{
     ...
     * @param array $InstanceDetails 实例详细信息
