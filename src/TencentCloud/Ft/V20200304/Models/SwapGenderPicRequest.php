 ...
 */
namespace Hdgtxcloud\Ft\V20200304\Models;
...
支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("GenderInfos",$param) and $param["GenderInfos"] !== null) {
            $this->GenderInfos = [];
            foreach ($param["GenderInfos"] as $key => $value){
                $obj = new GenderInfo();
                $obj->deserialize($value);
                array_push($this->GenderInfos, $obj);
            }
        }
