 ...
 * @method integer getPublic() 获取是否公共,1:公共,0:私有
 * @method void setPublic(integer $Public) 设置是否公共,1:公共,0:私有
...
class CreateRepositoryPersonalRequest extends AbstractModel
{
     ...
     * @param integer $Public 是否公共,1:公共,0:私有
