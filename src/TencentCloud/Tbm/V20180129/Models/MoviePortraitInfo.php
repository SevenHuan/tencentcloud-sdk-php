 ...
 */
namespace Hdgtxcloud\Tbm\V20180129\Models;
use TencentCloud\Common\AbstractModel;

/**
 * 用户喜好电影画像元素数组
 *
 * @method array getPortraitSet() 获取用户喜好电影画像数组
 * @method void setPortraitSet(array $PortraitSet) 设置用户喜好电影画像数组
 */
class MoviePortraitInfo extends AbstractModel
{
    /**
     * @var array 用户喜好电影画像数组
     */
    public $PortraitSet;

    /**
     * @param array $PortraitSet 用户喜好电影画像数组
     */
