 ...
 */
namespace Hdgtxcloud\Ds\V20180523\Models;
use TencentCloud\Common\AbstractModel;

/**
 * CreatePersonalAccount返回参数结构体
 *
 * @method string getAccountResId() 获取账号ID
 * @method void setAccountResId(string $AccountResId) 设置账号ID
...
class CreatePersonalAccountResponse extends AbstractModel
{
    ...
    /**
     * @param string $AccountResId 账号ID
