 ...
 * DescribeDBs返回参数结构体
 *
 * @method integer getTotalCount() 获取数据库数量
 * @method void setTotalCount(integer $TotalCount) 设置数据库数量
 * @method array getDBInstances() 获取实例数据库列表
 * @method void setDBInstances(array $DBInstances) 设置实例数据库列表
...
class DescribeDBsResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 数据库数量
     * @param array $DBInstances 实例数据库列表
