 ...
 *
 * @method integer getTotalCount() 获取备份总数量
 * @method void setTotalCount(integer $TotalCount) 设置备份总数量
 * @method array getBackups() 获取备份列表详情
 * @method void setBackups(array $Backups) 设置备份列表详情
...
class DescribeBackupsResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 备份总数量
     * @param array $Backups 备份列表详情
