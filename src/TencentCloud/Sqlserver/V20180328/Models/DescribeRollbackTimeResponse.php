 ...
 *
 * @method array getDetails() 获取数据库可回档实例信息
 * @method void setDetails(array $Details) 设置数据库可回档实例信息
...
class DescribeRollbackTimeResponse extends AbstractModel
{
    ...
    /**
     * @param array $Details 数据库可回档实例信息
