 ...
 *
 * @method integer getDefault() 获取默认持续时间，单位：秒
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setDefault(integer $Default) 设置默认持续时间，单位：秒
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getKeys() 获取可选持续时间，单位：秒
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setKeys(array $Keys) 设置可选持续时间，单位：秒
注意：此字段可能返回 null，表示取不到有效值。
...
{
    /**
     * @var integer 默认持续时间，单位：秒
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Default;

    /**
     * @var array 可选持续时间，单位：秒
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Keys;
    ...
    /**
     * @param integer $Default 默认持续时间，单位：秒
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $Keys 可选持续时间，单位：秒
注意：此字段可能返回 null，表示取不到有效值。
