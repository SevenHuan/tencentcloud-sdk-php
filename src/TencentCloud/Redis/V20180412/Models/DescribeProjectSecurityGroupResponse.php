 ...
 *
 * @method array getSecurityGroupDetails() 获取项目安全组
 * @method void setSecurityGroupDetails(array $SecurityGroupDetails) 设置项目安全组
...
class DescribeProjectSecurityGroupResponse extends AbstractModel
{
    ...
    /**
     * @param array $SecurityGroupDetails 项目安全组
