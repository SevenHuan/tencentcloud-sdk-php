...
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSuggestion(string $Suggestion) 设置Asr 文字涉黄结果建议，取值范围：
pass。
review。
block。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var float Asr 文字涉黄评分，分值为0到100。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Confidence;

    /**
     * @var string Asr 文字涉黄结果建议，取值范围：
pass。
review。
block。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $SegmentSet Asr 文字有涉黄嫌疑的视频片段列表。
注意：此字段可能返回 null，表示取不到有效值。
     */
