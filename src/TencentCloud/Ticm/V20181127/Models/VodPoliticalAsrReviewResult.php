...
注意：此字段可能返回 null，表示取不到有效值。
 * @method float getConfidence() 获取嫌疑片段审核结果建议，取值范围：
pass。
review。
block。
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setConfidence(float $Confidence) 设置嫌疑片段审核结果建议，取值范围：
pass。
review。
block。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param float $Confidence 嫌疑片段审核结果建议，取值范围：
pass。
review。
block。
