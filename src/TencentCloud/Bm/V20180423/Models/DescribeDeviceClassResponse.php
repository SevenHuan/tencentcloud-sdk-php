 ...
 *
 * @method array getDeviceClassSet() 获取物理机设备类型列表
 * @method void setDeviceClassSet(array $DeviceClassSet) 设置物理机设备类型列表
...
class DescribeDeviceClassResponse extends AbstractModel
{
    ...
    /**
     * @param array $DeviceClassSet 物理机设备类型列表
