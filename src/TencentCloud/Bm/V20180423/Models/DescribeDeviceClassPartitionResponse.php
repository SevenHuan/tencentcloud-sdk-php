 ...
 *
 * @method array getDeviceClassPartitionInfoSet() 获取支持的RAID格式列表
 * @method void setDeviceClassPartitionInfoSet(array $DeviceClassPartitionInfoSet) 设置支持的RAID格式列表
...
{
    /**
     * @var array 支持的RAID格式列表
     */
    public $DeviceClassPartitionInfoSet;
    ...
    /**
     * @param array $DeviceClassPartitionInfoSet 支持的RAID格式列表
