 ...
 *
 * @method integer getTotalCount() 获取满足条件的监听器总个数
 * @method void setTotalCount(integer $TotalCount) 设置满足条件的监听器总个数
 * @method array getListenerSet() 获取TCP监听器列表
 * @method void setListenerSet(array $ListenerSet) 设置TCP监听器列表
...
class DescribeTCPListenersResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 满足条件的监听器总个数
     * @param array $ListenerSet TCP监听器列表
