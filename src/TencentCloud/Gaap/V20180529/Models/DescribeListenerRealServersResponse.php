 ...
 *
 * @method integer getTotalCount() 获取可绑定源站的个数
 * @method void setTotalCount(integer $TotalCount) 设置可绑定源站的个数
 * @method array getRealServerSet() 获取源站信息列表
 * @method void setRealServerSet(array $RealServerSet) 设置源站信息列表
 * @method integer getBindRealServerTotalCount() 获取已绑定源站的个数
 * @method void setBindRealServerTotalCount(integer $BindRealServerTotalCount) 设置已绑定源站的个数
 * @method array getBindRealServerSet() 获取已绑定源站信息列表
 * @method void setBindRealServerSet(array $BindRealServerSet) 设置已绑定源站信息列表
...
class DescribeListenerRealServersResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 可绑定源站的个数
     * @param array $RealServerSet 源站信息列表
     * @param integer $BindRealServerTotalCount 已绑定源站的个数
     * @param array $BindRealServerSet 已绑定源站信息列表
