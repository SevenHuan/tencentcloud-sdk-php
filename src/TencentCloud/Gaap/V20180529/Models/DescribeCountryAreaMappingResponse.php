 ...
 *
 * @method array getCountryAreaMappingList() 获取国家地区编码映射表。
 * @method void setCountryAreaMappingList(array $CountryAreaMappingList) 设置国家地区编码映射表。
...
class DescribeCountryAreaMappingResponse extends AbstractModel
{
    ...
    /**
     * @param array $CountryAreaMappingList 国家地区编码映射表。
