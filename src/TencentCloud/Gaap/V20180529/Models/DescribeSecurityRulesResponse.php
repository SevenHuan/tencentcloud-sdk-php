 ...
 *
 * @method integer getTotalCount() 获取返回的安全规则详情总数。
 * @method void setTotalCount(integer $TotalCount) 设置返回的安全规则详情总数。
 * @method array getSecurityRuleSet() 获取返回的安全规则详情列表。
 * @method void setSecurityRuleSet(array $SecurityRuleSet) 设置返回的安全规则详情列表。
...
{
    /**
     * @var integer 返回的安全规则详情总数。
     */
    public $TotalCount;

    /**
     * @var array 返回的安全规则详情列表。
     */
    ...
    /**
     * @param integer $TotalCount 返回的安全规则详情总数。
     * @param array $SecurityRuleSet 返回的安全规则详情列表。
