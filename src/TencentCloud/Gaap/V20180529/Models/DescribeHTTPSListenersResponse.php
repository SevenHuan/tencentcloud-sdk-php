 ...
 *
 * @method integer getTotalCount() 获取监听器数量
 * @method void setTotalCount(integer $TotalCount) 设置监听器数量
 * @method array getListenerSet() 获取HTTPS监听器列表
 * @method void setListenerSet(array $ListenerSet) 设置HTTPS监听器列表
...
class DescribeHTTPSListenersResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 监听器数量
     * @param array $ListenerSet HTTPS监听器列表
