 ...
 *
 * @method ProxyInfo getProxyDetail() 获取通道详情信息。
 * @method void setProxyDetail(ProxyInfo $ProxyDetail) 设置通道详情信息。
...
class DescribeProxyDetailResponse extends AbstractModel
{
    ...
    /**
     * @param ProxyInfo $ProxyDetail 通道详情信息。
