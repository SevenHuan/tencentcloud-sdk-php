 ...
 *
 * @method array getInvalidStatusInstanceSet() 获取非运行状态下的通道实例ID列表，不可开启。
 * @method void setInvalidStatusInstanceSet(array $InvalidStatusInstanceSet) 设置非运行状态下的通道实例ID列表，不可开启。
...
{
    /**
     * @var array 非运行状态下的通道实例ID列表，不可开启。
     */
    ...
    /**
     * @param array $InvalidStatusInstanceSet 非运行状态下的通道实例ID列表，不可开启。
