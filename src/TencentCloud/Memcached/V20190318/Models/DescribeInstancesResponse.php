 ...
 */
namespace Hdgtxcloud\Memcached\V20190318\Models;
 ...
 * @method integer getTotalNum() 获取实例数量
 * @method void setTotalNum(integer $TotalNum) 设置实例数量
