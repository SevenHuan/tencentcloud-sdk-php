 ...
 * @method string getResourceRegion() 获取资源所在地域，不区分地域的资源不需要传入该字段
 * @method void setResourceRegion(string $ResourceRegion) 设置资源所在地域，不区分地域的资源不需要传入该字段
...
class ModifyResourcesTagValueRequest extends AbstractModel
{
    ...
    /**
     * @var string 资源所在地域，不区分地域的资源不需要传入该字段
     */
     ...
     * @param string $ResourceRegion 资源所在地域，不区分地域的资源不需要传入该字段
