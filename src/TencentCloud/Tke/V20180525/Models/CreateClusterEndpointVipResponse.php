 ...
 *
 * @method integer getRequestFlowId() 获取请求任务的FlowId
 * @method void setRequestFlowId(integer $RequestFlowId) 设置请求任务的FlowId
...
class CreateClusterEndpointVipResponse extends AbstractModel
{
    ...
    /**
     * @param integer $RequestFlowId 请求任务的FlowId
