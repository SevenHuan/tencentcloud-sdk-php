 ...
 */
namespace Hdgtxcloud\Cfs\V20190719\Models;
 ...
 * @method string getAuthClientIp() 获取允许访问的客户端 IP 或者 IP 段
 * @method void setAuthClientIp(string $AuthClientIp) 设置允许访问的客户端 IP 或者 IP 段
...
class UpdateCfsRuleResponse extends AbstractModel
{
    ...
    /**
     * @var string 允许访问的客户端 IP 或者 IP 段
     */
    public $AuthClientIp;
     ...
     * @param string $AuthClientIp 允许访问的客户端 IP 或者 IP 段
