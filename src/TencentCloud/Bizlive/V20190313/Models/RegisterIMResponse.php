 ...
 */
namespace Hdgtxcloud\Bizlive\V20190313\Models;
use TencentCloud\Common\AbstractModel;

/**
 * RegisterIM返回参数结构体
 *
 * @method string getUserKey() 获取用来传递给插件的关键字段
 * @method void setUserKey(string $UserKey) 设置用来传递给插件的关键字段
