...
- 支持音视频流分离并对音频流进行独立识别；
 * @method Models\CreateBizConfigResponse CreateBizConfig(Models\CreateBizConfigRequest $req) 创建业务配置，1个账号最多可以创建20个配置。在创建业务配置之前，你需要以下步骤：
...
class AmsClient extends AbstractClient
{
    ...
    {
        $respClass = "TencentCloud"."\\".ucfirst("ams")."\\"."V20200608\\Models"."\\".ucfirst($action)."Response";
        $obj = new $respClass();
