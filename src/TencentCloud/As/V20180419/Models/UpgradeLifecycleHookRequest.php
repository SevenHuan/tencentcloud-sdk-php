 ...
 * @method string getNotificationMetadata() 获取弹性伸缩向通知目标发送的附加信息，默认值为''
 * @method void setNotificationMetadata(string $NotificationMetadata) 设置弹性伸缩向通知目标发送的附加信息，默认值为''
...
class UpgradeLifecycleHookRequest extends AbstractModel
{
    ...
    /**
     * @var string 弹性伸缩向通知目标发送的附加信息，默认值为''
     */
     ...
     * @param string $NotificationMetadata 弹性伸缩向通知目标发送的附加信息，默认值为''
