 ...
 *
 * @method integer getTotalCount() 获取符合条件的启动配置数量。
 * @method void setTotalCount(integer $TotalCount) 设置符合条件的启动配置数量。
 * @method array getLaunchConfigurationSet() 获取启动配置详细信息列表。
 * @method void setLaunchConfigurationSet(array $LaunchConfigurationSet) 设置启动配置详细信息列表。
...
{
    /**
     * @var integer 符合条件的启动配置数量。
     */
    public $TotalCount;

    /**
     * @var array 启动配置详细信息列表。
     */
    ...
    /**
     * @param integer $TotalCount 符合条件的启动配置数量。
     * @param array $LaunchConfigurationSet 启动配置详细信息列表。
