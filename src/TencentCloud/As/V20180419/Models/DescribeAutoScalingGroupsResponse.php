 ...
 *
 * @method array getAutoScalingGroupSet() 获取伸缩组详细信息列表。
 * @method void setAutoScalingGroupSet(array $AutoScalingGroupSet) 设置伸缩组详细信息列表。
 * @method integer getTotalCount() 获取符合条件的伸缩组数量。
 * @method void setTotalCount(integer $TotalCount) 设置符合条件的伸缩组数量。
...
class DescribeAutoScalingGroupsResponse extends AbstractModel
{
    ...
    /**
     * @param array $AutoScalingGroupSet 伸缩组详细信息列表。
     * @param integer $TotalCount 符合条件的伸缩组数量。
