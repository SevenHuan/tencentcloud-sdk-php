 ...
 */
namespace Hdgtxcloud\Domain\V20180808\Models;
use Hdgtxcloud\Common\AbstractModel;

/**
 * DescribeDomainPriceList返回参数结构体
 *
 * @method array getPriceList() 获取域名价格列表
 * @method void setPriceList(array $PriceList) 设置域名价格列表
