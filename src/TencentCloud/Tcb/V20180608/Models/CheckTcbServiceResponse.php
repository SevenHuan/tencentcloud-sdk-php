 ...
 *
 * @method boolean getInitialized() 获取true表示已开通
 * @method void setInitialized(boolean $Initialized) 设置true表示已开通
...
class CheckTcbServiceResponse extends AbstractModel
{
    ...
    /**
     * @param boolean $Initialized true表示已开通
