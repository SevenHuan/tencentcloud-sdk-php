 ...
 *
 * @method string getJSONResp() 获取json格式response
 * @method void setJSONResp(string $JSONResp) 设置json格式response
...
class CommonServiceAPIResponse extends AbstractModel
{
    ...
    /**
     * @param string $JSONResp json格式response
