 ...
 *
 * @method array getPackageFreeQuotaInfos() 获取免费量资源信息列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setPackageFreeQuotaInfos(array $PackageFreeQuotaInfos) 设置免费量资源信息列表
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $PackageFreeQuotaInfos 免费量资源信息列表
注意：此字段可能返回 null，表示取不到有效值。
