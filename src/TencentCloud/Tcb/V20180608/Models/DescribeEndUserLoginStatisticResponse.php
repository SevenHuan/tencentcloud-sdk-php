 ...
 *
 * @method array getLoginStatistics() 获取环境终端用户新增与登录统计
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setLoginStatistics(array $LoginStatistics) 设置环境终端用户新增与登录统计
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $LoginStatistics 环境终端用户新增与登录统计
注意：此字段可能返回 null，表示取不到有效值。
