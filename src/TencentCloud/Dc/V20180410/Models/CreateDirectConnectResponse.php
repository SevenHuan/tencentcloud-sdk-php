 ...
 *
 * @method array getDirectConnectIdSet() 获取物理专线的ID。
 * @method void setDirectConnectIdSet(array $DirectConnectIdSet) 设置物理专线的ID。
...
class CreateDirectConnectResponse extends AbstractModel
{
    ...
    /**
     * @param array $DirectConnectIdSet 物理专线的ID。
