...
<li>当字符串以 px 结尾，表示水印 YPos 为指定像素，如 100px 表示 YPos 为 100 像素。</li>
默认值：0px。
 * @method ImageWatermarkInput getImageTemplate() 获取图片水印模板，仅当 Type 为 image，该字段必填且有效。
 * @method void setImageTemplate(ImageWatermarkInput $ImageTemplate) 设置图片水印模板，仅当 Type 为 image，该字段必填且有效。
 * @method TextWatermarkTemplateInput getTextTemplate() 获取文字水印模板，仅当 Type 为 text，该字段必填且有效。
...
默认值：0px。
    ...
    /**
     * @var ImageWatermarkInput 图片水印模板，仅当 Type 为 image，该字段必填且有效。
     */
    public $ImageTemplate;

    /**
     * @var TextWatermarkTemplateInput 文字水印模板，仅当 Type 为 text，该字段必填且有效。
     */
    public $TextTemplate;
...
<li>当字符串以 px 结尾，表示水印 YPos 为指定像素，如 100px 表示 YPos 为 100 像素。</li>
默认值：0px。
     * @param ImageWatermarkInput $ImageTemplate 图片水印模板，仅当 Type 为 image，该字段必填且有效。
     * @param TextWatermarkTemplateInput $TextTemplate 文字水印模板，仅当 Type 为 text，该字段必填且有效。
     * @param SvgWatermarkInput $SvgTemplate SVG 水印模板，仅当 Type 为 svg，该字段必填且有效。
     */
