 ...
 * @method array getImageSpriteTemplateSet() 获取雪碧图模板详情列表。
 * @method void setImageSpriteTemplateSet(array $ImageSpriteTemplateSet) 设置雪碧图模板详情列表。
...
class DescribeImageSpriteTemplatesResponse extends AbstractModel
{
     ...
     * @param array $ImageSpriteTemplateSet 雪碧图模板详情列表。
