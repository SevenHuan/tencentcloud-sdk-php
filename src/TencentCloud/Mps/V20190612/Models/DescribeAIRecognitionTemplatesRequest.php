 ...
 *
 * @method array getDefinitions() 获取视频内容识别模板唯一标识过滤条件，数组长度限制：10。
 * @method void setDefinitions(array $Definitions) 设置视频内容识别模板唯一标识过滤条件，数组长度限制：10。
...
{
    /**
     * @var array 视频内容识别模板唯一标识过滤条件，数组长度限制：10。
     */
    public $Definitions;
