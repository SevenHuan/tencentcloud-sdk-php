 ...
 * 图片水印模板输入参数
 *
 * @method MediaInputInfo getImageContent() 获取水印图片的输入内容。支持 jpeg、png 图片格式。
 * @method void setImageContent(MediaInputInfo $ImageContent) 设置水印图片的输入内容。支持 jpeg、png 图片格式。
...
{
    /**
     * @var MediaInputInfo 水印图片的输入内容。支持 jpeg、png 图片格式。
     */
    public $ImageContent;
