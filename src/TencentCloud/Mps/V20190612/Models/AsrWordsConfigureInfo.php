 ...
 * 语音关键词识别控制参数。
 *
 * @method string getSwitch() 获取语音关键词识别任务开关，可选值：
<li>ON：开启语音关键词识别任务；</li>
<li>OFF：关闭语音关键词识别任务。</li>
 * @method void setSwitch(string $Switch) 设置语音关键词识别任务开关，可选值：
<li>ON：开启语音关键词识别任务；</li>
<li>OFF：关闭语音关键词识别任务。</li>
...
标签个数最多 10 个，每个标签长度最多 16 个字符。
    ...
    /**
     * @param string $Switch 语音关键词识别任务开关，可选值：
<li>ON：开启语音关键词识别任务；</li>
<li>OFF：关闭语音关键词识别任务。</li>
