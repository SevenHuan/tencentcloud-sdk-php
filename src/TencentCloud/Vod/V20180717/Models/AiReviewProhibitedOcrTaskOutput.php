...
<li>review。</li>
<li>block。</li>
 * @method void setSuggestion(string $Suggestion) 设置Ocr 文字涉违禁结果建议，取值范围：
<li>pass。</li>
<li>review。</li>
<li>block。</li>
...
{
    /**
     * @var float Ocr 文字涉违禁评分，分值为0到100。
     */
    public $Confidence;

    /**
     * @var string Ocr 文字涉违禁结果建议，取值范围：
<li>pass。</li>
<li>review。</li>
<li>block。</li>
     */
...
<li>review。</li>
<li>block。</li>
     * @param array $SegmentSet Ocr 文字有涉违禁嫌疑的视频片段列表。
     */
