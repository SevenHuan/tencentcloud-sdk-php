 ...
 * @method AiReviewPoliticalTaskInput getInput() 获取内容审核鉴政任务输入。
 * @method void setInput(AiReviewPoliticalTaskInput $Input) 设置内容审核鉴政任务输入。
 * @method AiReviewPoliticalTaskOutput getOutput() 获取内容审核鉴政任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPoliticalTaskOutput $Output) 设置内容审核鉴政任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
...
<li>70000：内部服务错误，建议重试。</li>
    ...
    /**
     * @var AiReviewPoliticalTaskInput 内容审核鉴政任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPoliticalTaskOutput 内容审核鉴政任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
...
<li>70000：内部服务错误，建议重试。</li>
     ...
     * @param AiReviewPoliticalTaskInput $Input 内容审核鉴政任务输入。
     * @param AiReviewPoliticalTaskOutput $Output 内容审核鉴政任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
