 ...
 * @method AiReviewPornOcrTaskInput getInput() 获取内容审核 Ocr 文字鉴黄任务输入。
 * @method void setInput(AiReviewPornOcrTaskInput $Input) 设置内容审核 Ocr 文字鉴黄任务输入。
 * @method AiReviewPornOcrTaskOutput getOutput() 获取内容审核 Ocr 文字鉴黄任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPornOcrTaskOutput $Output) 设置内容审核 Ocr 文字鉴黄任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
...
<li>70000：内部服务错误，建议重试。</li>
    ...
    /**
     * @var AiReviewPornOcrTaskInput 内容审核 Ocr 文字鉴黄任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPornOcrTaskOutput 内容审核 Ocr 文字鉴黄任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
...
<li>70000：内部服务错误，建议重试。</li>
     ...
     * @param AiReviewPornOcrTaskInput $Input 内容审核 Ocr 文字鉴黄任务输入。
     * @param AiReviewPornOcrTaskOutput $Output 内容审核 Ocr 文字鉴黄任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
