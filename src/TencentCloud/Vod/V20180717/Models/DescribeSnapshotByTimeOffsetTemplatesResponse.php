 ...
 * @method array getSnapshotByTimeOffsetTemplateSet() 获取指定时间点截图模板详情列表。
 * @method void setSnapshotByTimeOffsetTemplateSet(array $SnapshotByTimeOffsetTemplateSet) 设置指定时间点截图模板详情列表。
...
class DescribeSnapshotByTimeOffsetTemplatesResponse extends AbstractModel
{
    ...
    /**
     * @var array 指定时间点截图模板详情列表。
     */
    public $SnapshotByTimeOffsetTemplateSet;
     ...
     * @param array $SnapshotByTimeOffsetTemplateSet 指定时间点截图模板详情列表。
