 ...
 *
 * @method array getDefinitions() 获取采样截图模板唯一标识过滤条件，数组长度限制：100。
 * @method void setDefinitions(array $Definitions) 设置采样截图模板唯一标识过滤条件，数组长度限制：100。
...
{
    /**
     * @var array 采样截图模板唯一标识过滤条件，数组长度限制：100。
     */
    public $Definitions;
...
<li>Custom：用户自定义模板。</li>
    ...
    /**
     * @param array $Definitions 采样截图模板唯一标识过滤条件，数组长度限制：100。
