...
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getHardwareResourceTypeList() 获取资源类型列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setHardwareResourceTypeList(array $HardwareResourceTypeList) 设置资源类型列表
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $HardwareResourceTypeList 资源类型列表
注意：此字段可能返回 null，表示取不到有效值。
