 ...
 *
 * @method Price getPrice() 获取该参数表示对应配置实例转换计费模式的价格。
 * @method void setPrice(Price $Price) 设置该参数表示对应配置实例转换计费模式的价格。
...
{
    /**
     * @var Price 该参数表示对应配置实例转换计费模式的价格。
     */
    public $Price;
    ...
    /**
     * @param Price $Price 该参数表示对应配置实例转换计费模式的价格。
