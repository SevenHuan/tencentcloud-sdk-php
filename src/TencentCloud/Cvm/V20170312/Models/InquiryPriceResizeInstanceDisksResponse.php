 ...
 *
 * @method Price getPrice() 获取该参数表示磁盘扩容成对应配置的价格。
 * @method void setPrice(Price $Price) 设置该参数表示磁盘扩容成对应配置的价格。
...
class InquiryPriceResizeInstanceDisksResponse extends AbstractModel
{
    ...
    /**
     * @param Price $Price 该参数表示磁盘扩容成对应配置的价格。
