 ...
 *
 * @method Price getPrice() 获取该参数表示带宽调整为对应大小之后的价格。
 * @method void setPrice(Price $Price) 设置该参数表示带宽调整为对应大小之后的价格。
...
class InquiryPriceResetInstancesInternetMaxBandwidthResponse extends AbstractModel
{
    ...
    /**
     * @param Price $Price 该参数表示带宽调整为对应大小之后的价格。
