 ...
 *
 * @method Price getPrice() 获取该参数表示调整成对应机型实例的价格。
 * @method void setPrice(Price $Price) 设置该参数表示调整成对应机型实例的价格。
...
class InquiryPriceResetInstancesTypeResponse extends AbstractModel
{
    ...
    /**
     * @param Price $Price 该参数表示调整成对应机型实例的价格。
