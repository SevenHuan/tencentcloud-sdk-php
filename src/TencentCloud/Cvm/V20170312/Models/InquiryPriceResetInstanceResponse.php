 ...
 *
 * @method Price getPrice() 获取该参数表示重装成对应配置实例的价格。
 * @method void setPrice(Price $Price) 设置该参数表示重装成对应配置实例的价格。
...
class InquiryPriceResetInstanceResponse extends AbstractModel
{
    ...
    /**
     * @param Price $Price 该参数表示重装成对应配置实例的价格。
