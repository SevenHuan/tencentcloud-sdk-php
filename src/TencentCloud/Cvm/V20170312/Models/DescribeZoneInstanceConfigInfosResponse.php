 ...
 *
 * @method array getInstanceTypeQuotaSet() 获取可用区机型配置列表。
 * @method void setInstanceTypeQuotaSet(array $InstanceTypeQuotaSet) 设置可用区机型配置列表。
...
class DescribeZoneInstanceConfigInfosResponse extends AbstractModel
{
    ...
    /**
     * @param array $InstanceTypeQuotaSet 可用区机型配置列表。
