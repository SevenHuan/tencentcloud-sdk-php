 ...
 *
 * @method integer getTotalCount() 获取满足本次条件的队列个数
 * @method void setTotalCount(integer $TotalCount) 设置满足本次条件的队列个数
 * @method array getQueueSet() 获取死信队列源队列
 * @method void setQueueSet(array $QueueSet) 设置死信队列源队列
...
class DescribeDeadLetterSourceQueuesResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 满足本次条件的队列个数
     * @param array $QueueSet 死信队列源队列
