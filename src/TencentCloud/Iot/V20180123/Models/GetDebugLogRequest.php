 ...
 * @method string getType() 获取日志类型（shadow/action/mqtt）
 * @method void setType(string $Type) 设置日志类型（shadow/action/mqtt）
 */
class GetDebugLogRequest extends AbstractModel
{
    ...
    /**
     * @var string 日志类型（shadow/action/mqtt）
     */
    public $Type;
     ...
     * @param string $Type 日志类型（shadow/action/mqtt）
     */
