 ...
 *
 * @method array getSubscribeIds() 获取数据订阅实例的ID数组
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSubscribeIds(array $SubscribeIds) 设置数据订阅实例的ID数组
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $SubscribeIds 数据订阅实例的ID数组
注意：此字段可能返回 null，表示取不到有效值。
