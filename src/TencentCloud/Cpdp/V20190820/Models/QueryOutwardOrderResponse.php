 ...
 *
 * @method QueryOutwardOrderResult getResult() 获取查询汇出结果
 * @method void setResult(QueryOutwardOrderResult $Result) 设置查询汇出结果
...
{
    /**
     * @var QueryOutwardOrderResult 查询汇出结果
     */
    public $Result;
    ...
    /**
     * @param QueryOutwardOrderResult $Result 查询汇出结果
