 ...
 * @method string getFrontSeqNo() 获取STRING(52)，见证系统流水号（即电商见证宝系统生成的流水号，可关联具体一笔请求）
 * @method void setFrontSeqNo(string $FrontSeqNo) 设置STRING(52)，见证系统流水号（即电商见证宝系统生成的流水号，可关联具体一笔请求）
...
class CheckAmountResponse extends AbstractModel
{
    ...
    /**
     * @var string STRING(52)，见证系统流水号（即电商见证宝系统生成的流水号，可关联具体一笔请求）
     */
    public $FrontSeqNo;
     ...
     * @param string $FrontSeqNo STRING(52)，见证系统流水号（即电商见证宝系统生成的流水号，可关联具体一笔请求）
