 ...
 * @method ApplyPayerinfoData getData() 获取数据
 * @method void setData(ApplyPayerinfoData $Data) 设置数据
 */
class ApplyPayerinfoResult extends AbstractModel
{
    ...
    /**
     * @var ApplyPayerinfoData 数据
     */
    public $Data;

    /**
     * @param string $Code 错误码
     * @param ApplyPayerinfoData $Data 数据
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Data",$param) and $param["Data"] !== null) {
            $this->Data = new ApplyPayerinfoData();
