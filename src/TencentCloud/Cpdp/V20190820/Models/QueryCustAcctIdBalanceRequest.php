 ...
 * @method void setQueryFlag(string $QueryFlag) 设置STRING(4)，查询标志（2: 普通会员子账号; 3: 功能子账号）
 ...
 * @method string getSubAcctNo() 获取STRING(50)，见证子账户的账号（若SelectFlag为2时，子账号必输）
...
class QueryCustAcctIdBalanceRequest extends AbstractModel
{
    ...
    /**
     * @var string STRING(4)，查询标志（2: 普通会员子账号; 3: 功能子账号）
     */
    public $QueryFlag;
    ...
    /**
     * @var string STRING(50)，见证子账户的账号（若SelectFlag为2时，子账号必输）
     */
    public $SubAcctNo;
     ...
     * @param string $SubAcctNo STRING(50)，见证子账户的账号（若SelectFlag为2时，子账号必输）
