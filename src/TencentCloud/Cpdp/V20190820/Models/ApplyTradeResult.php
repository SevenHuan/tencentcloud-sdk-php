 ...
 * @method ApplyTradeData getData() 获取提交贸易材料数据
 * @method void setData(ApplyTradeData $Data) 设置提交贸易材料数据
 */
class ApplyTradeResult extends AbstractModel
{
    ...
    /**
     * @var ApplyTradeData 提交贸易材料数据
     */
    public $Data;

    /**
     * @param string $Code 错误码
     * @param ApplyTradeData $Data 提交贸易材料数据
     */
