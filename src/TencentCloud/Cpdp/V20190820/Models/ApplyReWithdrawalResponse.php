 ...
 *
 * @method string getWithdrawOrderId() 获取重新提现业务订单号
 * @method void setWithdrawOrderId(string $WithdrawOrderId) 设置重新提现业务订单号
...
class ApplyReWithdrawalResponse extends AbstractModel
{
    ...
    /**
     * @param string $WithdrawOrderId 重新提现业务订单号
