 ...
 *
 * @method array getAnchorContractInfoList() 获取签约主播数据
 * @method void setAnchorContractInfoList(array $AnchorContractInfoList) 设置签约主播数据
...
class QueryAnchorContractInfoResponse extends AbstractModel
{
    ...
    /**
     * @param array $AnchorContractInfoList 签约主播数据
