 ...
 *
 * @method DBInstance getDBInstance() 获取实例详细信息。
 * @method void setDBInstance(DBInstance $DBInstance) 设置实例详细信息。
...
class DescribeDBInstanceAttributeResponse extends AbstractModel
{
    ...
    /**
     * @param DBInstance $DBInstance 实例详细信息。
