 ...
 * @method string getModifyTime() 获取规则修改时间
 * @method void setModifyTime(string $ModifyTime) 设置规则修改时间
 * @method integer getRegion() 获取对应地区信息
 * @method void setRegion(integer $Region) 设置对应地区信息
 * @method string getIp() 获取绑定资源IP信息
 * @method void setIp(string $Ip) 设置绑定资源IP信息
 * @method string getId() 获取绑定资源Id信息
 * @method void setId(string $Id) 设置绑定资源Id信息
 */
class NewL4RuleEntry extends AbstractModel
{
     ...
     * @param string $ModifyTime 规则修改时间
     * @param integer $Region 对应地区信息
     * @param string $Ip 绑定资源IP信息
     * @param string $Id 绑定资源Id信息
     */
