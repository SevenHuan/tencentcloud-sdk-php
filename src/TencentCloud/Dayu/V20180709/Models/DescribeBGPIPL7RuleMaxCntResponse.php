 ...
 *
 * @method integer getCount() 获取高防IP最多可添加的7层规则数量
 * @method void setCount(integer $Count) 设置高防IP最多可添加的7层规则数量
...
class DescribeBGPIPL7RuleMaxCntResponse extends AbstractModel
{
    ...
    /**
     * @param integer $Count 高防IP最多可添加的7层规则数量
