 ...
 * @method array getHealths() 获取四层健康检查配置列表
 * @method void setHealths(array $Healths) 设置四层健康检查配置列表
...
class DescribeNewL4RulesResponse extends AbstractModel
{
     ...
     * @param array $Healths 四层健康检查配置列表
