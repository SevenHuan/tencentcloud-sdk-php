 ...
 * @method string getFilter() 获取搜索值，只支持资源ID或用户UIN
 * @method void setFilter(string $Filter) 设置搜索值，只支持资源ID或用户UIN
...
class DescribeActionLogRequest extends AbstractModel
{
     ...
     * @param string $Filter 搜索值，只支持资源ID或用户UIN
