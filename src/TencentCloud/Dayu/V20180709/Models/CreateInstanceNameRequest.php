 ...
 * @method string getName() 获取资源实例名称，长度不超过32个字符
 * @method void setName(string $Name) 设置资源实例名称，长度不超过32个字符
 */
class CreateInstanceNameRequest extends AbstractModel
{
     ...
     * @param string $Name 资源实例名称，长度不超过32个字符
     */
