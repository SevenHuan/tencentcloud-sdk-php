 ...
 * @method string getMethod() 获取add表示添加，delete表示删除
 * @method void setMethod(string $Method) 设置add表示添加，delete表示删除
 * @method string getType() 获取黑/白名单类型；取值[white(白名单)，black(黑名单)]
...
class ModifyCCIpAllowDenyRequest extends AbstractModel
{
    ...
    /**
     * @var string 黑/白名单类型；取值[white(白名单)，black(黑名单)]
     */
    public $Type;

    /**
     * @var array 黑/白名单的IP数组
     */
    public $IpList;
