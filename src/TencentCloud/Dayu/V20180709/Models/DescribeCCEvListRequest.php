 ...
 * @method array getIpList() 获取资源实例的IP，当business不为basic时，如果IpList不为空则Id也必须不能为空；
 * @method void setIpList(array $IpList) 设置资源实例的IP，当business不为basic时，如果IpList不为空则Id也必须不能为空；
...
class DescribeCCEvListRequest extends AbstractModel
{
    ...
    /**
     * @var array 资源实例的IP，当business不为basic时，如果IpList不为空则Id也必须不能为空；
     */
    public $IpList;
     ...
     * @param array $IpList 资源实例的IP，当business不为basic时，如果IpList不为空则Id也必须不能为空；
