 ...
 *
 * @method array getDDosPolicyList() 获取DDoS高级策略列表
 * @method void setDDosPolicyList(array $DDosPolicyList) 设置DDoS高级策略列表
...
{
    /**
     * @var array DDoS高级策略列表
     */
    public $DDosPolicyList;
    ...
    /**
     * @param array $DDosPolicyList DDoS高级策略列表
