 ...
 * @method array getAddressIds() 获取标识 EIP 的唯一 ID 列表。
 * @method void setAddressIds(array $AddressIds) 设置标识 EIP 的唯一 ID 列表。
 */
class ReleaseAddressesRequest extends AbstractModel
{
    ...
    /**
     * @var array 标识 EIP 的唯一 ID 列表。
     */
    public $AddressIds;

    /**
     * @param string $EcmRegion ECM 地域
     * @param array $AddressIds 标识 EIP 的唯一 ID 列表。
     */
