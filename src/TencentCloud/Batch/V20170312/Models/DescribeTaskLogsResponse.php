 ...
 *
 * @method integer getTotalCount() 获取任务实例总数
 * @method void setTotalCount(integer $TotalCount) 设置任务实例总数
 * @method array getTaskInstanceLogSet() 获取任务实例日志详情集合
 * @method void setTaskInstanceLogSet(array $TaskInstanceLogSet) 设置任务实例日志详情集合
...
class DescribeTaskLogsResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 任务实例总数
     * @param array $TaskInstanceLogSet 任务实例日志详情集合
