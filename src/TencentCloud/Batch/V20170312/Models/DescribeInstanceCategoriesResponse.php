 ...
 *
 * @method array getInstanceCategorySet() 获取CVM实例分类列表
 * @method void setInstanceCategorySet(array $InstanceCategorySet) 设置CVM实例分类列表
...
class DescribeInstanceCategoriesResponse extends AbstractModel
{
    ...
    /**
     * @param array $InstanceCategorySet CVM实例分类列表
