 ...
 *
 * @method string getZipCode() 获取生成的源代码(zip压缩后的base64编码)
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setZipCode(string $ZipCode) 设置生成的源代码(zip压缩后的base64编码)
注意：此字段可能返回 null，表示取不到有效值。
...
{
    /**
     * @var string 生成的源代码(zip压缩后的base64编码)
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $ZipCode;
    ...
    /**
     * @param string $ZipCode 生成的源代码(zip压缩后的base64编码)
注意：此字段可能返回 null，表示取不到有效值。
