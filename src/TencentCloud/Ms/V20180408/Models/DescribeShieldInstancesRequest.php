 ...
 */
namespace Hdgtxcloud\Ms\V20180408\Models;
use TencentCloud\Common\AbstractModel;

/**
 * DescribeShieldInstances请求参数结构体
 *
 * @method array getFilters() 获取支持通过app名称，app包名，加固的服务版本，提交的渠道进行筛选。
 * @method void setFilters(array $Filters) 设置支持通过app名称，app包名，加固的服务版本，提交的渠道进行筛选。
...
{
    /**
     * @var array 支持通过app名称，app包名，加固的服务版本，提交的渠道进行筛选。
     */
    public $Filters;
