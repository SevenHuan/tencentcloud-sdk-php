 ...
 *
 * @method array getListenerSet() 获取监听器列表。
 * @method void setListenerSet(array $ListenerSet) 设置监听器列表。
 * @method integer getTotalCount() 获取监听器总数。
 * @method void setTotalCount(integer $TotalCount) 设置监听器总数。
...
class DescribeTrafficMirrorListenersResponse extends AbstractModel
{
    ...
    /**
     * @param array $ListenerSet 监听器列表。
     * @param integer $TotalCount 监听器总数。
