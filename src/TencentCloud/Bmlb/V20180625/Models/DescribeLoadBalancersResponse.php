 ...
 *
 * @method array getLoadBalancerSet() 获取返回负载均衡信息列表。
 * @method void setLoadBalancerSet(array $LoadBalancerSet) 设置返回负载均衡信息列表。
 * @method integer getTotalCount() 获取符合条件的负载均衡总数。
 * @method void setTotalCount(integer $TotalCount) 设置符合条件的负载均衡总数。
...
{
    /**
     * @var array 返回负载均衡信息列表。
     */
    public $LoadBalancerSet;

    /**
     * @var integer 符合条件的负载均衡总数。
     */
    public $TotalCount;
    ...
    /**
     * @param array $LoadBalancerSet 返回负载均衡信息列表。
     * @param integer $TotalCount 符合条件的负载均衡总数。
