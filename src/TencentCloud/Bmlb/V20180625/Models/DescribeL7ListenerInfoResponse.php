 ...
 *
 * @method array getListenerSet() 获取返回的七层监听器列表。
 * @method void setListenerSet(array $ListenerSet) 设置返回的七层监听器列表。
...
class DescribeL7ListenerInfoResponse extends AbstractModel
{
    ...
    /**
     * @param array $ListenerSet 返回的七层监听器列表。
