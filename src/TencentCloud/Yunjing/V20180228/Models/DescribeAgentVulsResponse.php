 ...
 * @method array getAgentVuls() 获取主机漏洞信息
 * @method void setAgentVuls(array $AgentVuls) 设置主机漏洞信息
...
class DescribeAgentVulsResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AgentVuls",$param) and $param["AgentVuls"] !== null) {
            $this->AgentVuls = [];
            foreach ($param["AgentVuls"] as $key => $value){
                $obj = new AgentVul();
                $obj->deserialize($value);
                array_push($this->AgentVuls, $obj);
            }
        }
