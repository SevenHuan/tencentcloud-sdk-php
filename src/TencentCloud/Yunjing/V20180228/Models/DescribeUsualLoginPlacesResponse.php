 ...
 *
 * @method array getUsualLoginPlaces() 获取常用登录地数组
 * @method void setUsualLoginPlaces(array $UsualLoginPlaces) 设置常用登录地数组
...
class DescribeUsualLoginPlacesResponse extends AbstractModel
{
    ...
    /**
     * @param array $UsualLoginPlaces 常用登录地数组
