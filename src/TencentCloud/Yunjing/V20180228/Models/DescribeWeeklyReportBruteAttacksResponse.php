 ...
 *
 * @method array getWeeklyReportBruteAttacks() 获取专业周报密码破解数组。
 * @method void setWeeklyReportBruteAttacks(array $WeeklyReportBruteAttacks) 设置专业周报密码破解数组。
...
class DescribeWeeklyReportBruteAttacksResponse extends AbstractModel
{
    ...
    /**
     * @param array $WeeklyReportBruteAttacks 专业周报密码破解数组。
