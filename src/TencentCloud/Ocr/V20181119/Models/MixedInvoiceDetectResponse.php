 ...
 *
 * @method array getInvoiceDetectInfos() 获取检测出的票据类型列表，具体内容请点击左侧链接。
 * @method void setInvoiceDetectInfos(array $InvoiceDetectInfos) 设置检测出的票据类型列表，具体内容请点击左侧链接。
...
{
    /**
     * @var array 检测出的票据类型列表，具体内容请点击左侧链接。
     */
    public $InvoiceDetectInfos;
    ...
    /**
     * @param array $InvoiceDetectInfos 检测出的票据类型列表，具体内容请点击左侧链接。
