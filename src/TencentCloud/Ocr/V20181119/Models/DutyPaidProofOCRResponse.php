 ...
 *
 * @method array getDutyPaidProofInfos() 获取完税证明识别结果，具体内容请点击左侧链接。
 * @method void setDutyPaidProofInfos(array $DutyPaidProofInfos) 设置完税证明识别结果，具体内容请点击左侧链接。
...
{
    /**
     * @var array 完税证明识别结果，具体内容请点击左侧链接。
     */
    public $DutyPaidProofInfos;
    ...
    /**
     * @param array $DutyPaidProofInfos 完税证明识别结果，具体内容请点击左侧链接。
