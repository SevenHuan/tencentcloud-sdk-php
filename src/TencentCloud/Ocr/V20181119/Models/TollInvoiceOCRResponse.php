 ...
 *
 * @method array getTollInvoiceInfos() 获取过路过桥费发票识别结果，具体内容请点击左侧链接。
 * @method void setTollInvoiceInfos(array $TollInvoiceInfos) 设置过路过桥费发票识别结果，具体内容请点击左侧链接。
...
{
    /**
     * @var array 过路过桥费发票识别结果，具体内容请点击左侧链接。
     */
    public $TollInvoiceInfos;
    ...
    /**
     * @param array $TollInvoiceInfos 过路过桥费发票识别结果，具体内容请点击左侧链接。
