 ...
 *
 * @method array getShipInvoiceInfos() 获取轮船票识别结果，具体内容请点击左侧链接。
 * @method void setShipInvoiceInfos(array $ShipInvoiceInfos) 设置轮船票识别结果，具体内容请点击左侧链接。
...
{
    /**
     * @var array 轮船票识别结果，具体内容请点击左侧链接。
     */
    public $ShipInvoiceInfos;
    ...
    /**
     * @param array $ShipInvoiceInfos 轮船票识别结果，具体内容请点击左侧链接。
