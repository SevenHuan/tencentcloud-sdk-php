 ...
 * FinanBillOCR返回参数结构体
 *
 * @method array getFinanBillInfos() 获取金融票据整单识别结果，具体内容请点击左侧链接。
 * @method void setFinanBillInfos(array $FinanBillInfos) 设置金融票据整单识别结果，具体内容请点击左侧链接。
...
{
    /**
     * @var array 金融票据整单识别结果，具体内容请点击左侧链接。
     */
    public $FinanBillInfos;
    ...
    /**
     * @param array $FinanBillInfos 金融票据整单识别结果，具体内容请点击左侧链接。
