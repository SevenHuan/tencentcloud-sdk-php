 ...
 * @method array getLibrarySet() 获取查询人员库列表，可填写老师的注册照所在人员库
 * @method void setLibrarySet(array $LibrarySet) 设置查询人员库列表，可填写老师的注册照所在人员库
 ...
 * @method array getVocabLibNameList() 获取识别词库名列表，这些词汇库用来维护关键词，评估老师授课过程中，对这些关键词的使用情况
 * @method void setVocabLibNameList(array $VocabLibNameList) 设置识别词库名列表，这些词汇库用来维护关键词，评估老师授课过程中，对这些关键词的使用情况
...
class SubmitFullBodyClassTaskRequest extends AbstractModel
{
    ...
    /**
     * @var array 查询人员库列表，可填写老师的注册照所在人员库
     */
    public $LibrarySet;
    ...
    /**
     * @var array 识别词库名列表，这些词汇库用来维护关键词，评估老师授课过程中，对这些关键词的使用情况
     */
     ...
     * @param array $LibrarySet 查询人员库列表，可填写老师的注册照所在人员库
     * @param integer $MaxVideoDuration 视频评估时间，单位秒，点播场景默认值为2小时（无法探测长度时）或完整视频，直播场景默认值为10分钟或直播提前结束
     * @param array $VocabLibNameList 识别词库名列表，这些词汇库用来维护关键词，评估老师授课过程中，对这些关键词的使用情况
     * @param integer $VoiceEncodeType 语音编码类型 1:pcm，当FileType为vod_url或live_url时为必填
     * @param integer $VoiceFileType 语音文件类型 10:视频（三种音频格式目前仅支持16k采样率16bit），当FileType为vod_url或live_url时为必填
     */
