 ...
 * AIAssistant返回参数结构体
 *
 * @method array getImageResults() 获取图像任务直接返回结果
 * @method void setImageResults(array $ImageResults) 设置图像任务直接返回结果
...
class AIAssistantResponse extends AbstractModel
{
    ...
    /**
     * @param array $ImageResults 图像任务直接返回结果
