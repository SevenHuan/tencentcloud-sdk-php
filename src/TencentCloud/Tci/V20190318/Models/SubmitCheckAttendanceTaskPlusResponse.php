 ...
 * @method string getNotRegisteredSet() 获取没有注册的人的ID列表
 * @method void setNotRegisteredSet(string $NotRegisteredSet) 设置没有注册的人的ID列表
...
class SubmitCheckAttendanceTaskPlusResponse extends AbstractModel
{
     ...
     * @param string $NotRegisteredSet 没有注册的人的ID列表
