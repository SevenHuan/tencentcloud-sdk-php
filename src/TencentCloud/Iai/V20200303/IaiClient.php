...
namespace Hdgtxcloud\Iai\V20200303;

use Hdgtxcloud\Common\AbstractClient;
use Hdgtxcloud\Common\Profile\ClientProfile;
use Hdgtxcloud\Common\Credential;
use Hdgtxcloud\Iai\V20200303\Models as Models;
...
>     
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
 * @method Models\VerifyPersonResponse VerifyPerson(Models\VerifyPersonRequest $req) 给定一张人脸图片和一个 PersonId，判断图片中的人和 PersonId 对应的人是否为同一人。PersonId 请参考[人员库管理相关接口](https://cloud.tencent.com/document/product/867/45015)。
