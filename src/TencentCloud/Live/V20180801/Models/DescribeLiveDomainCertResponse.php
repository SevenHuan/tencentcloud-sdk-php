 ...
 *
 * @method DomainCertInfo getDomainCertInfo() 获取证书信息。
 * @method void setDomainCertInfo(DomainCertInfo $DomainCertInfo) 设置证书信息。
...
class DescribeLiveDomainCertResponse extends AbstractModel
{
    ...
    /**
     * @param DomainCertInfo $DomainCertInfo 证书信息。
