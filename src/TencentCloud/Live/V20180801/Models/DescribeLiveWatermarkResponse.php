 ...
 *
 * @method WatermarkInfo getWatermark() 获取水印信息。
 * @method void setWatermark(WatermarkInfo $Watermark) 设置水印信息。
...
class DescribeLiveWatermarkResponse extends AbstractModel
{
    ...
    /**
     * @param WatermarkInfo $Watermark 水印信息。
