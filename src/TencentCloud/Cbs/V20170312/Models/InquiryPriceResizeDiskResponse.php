 ...
 *
 * @method PrepayPrice getDiskPrice() 获取描述了扩容云盘的价格。
 * @method void setDiskPrice(PrepayPrice $DiskPrice) 设置描述了扩容云盘的价格。
...
class InquiryPriceResizeDiskResponse extends AbstractModel
{
    ...
    /**
     * @param PrepayPrice $DiskPrice 描述了扩容云盘的价格。
