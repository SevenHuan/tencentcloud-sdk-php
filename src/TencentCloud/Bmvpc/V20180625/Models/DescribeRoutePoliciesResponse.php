 ...
 *
 * @method integer getTotalCount() 获取路由策略数
 * @method void setTotalCount(integer $TotalCount) 设置路由策略数
 * @method array getRoutePolicySet() 获取路由策略列表
 * @method void setRoutePolicySet(array $RoutePolicySet) 设置路由策略列表
...
class DescribeRoutePoliciesResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 路由策略数
     * @param array $RoutePolicySet 路由策略列表
