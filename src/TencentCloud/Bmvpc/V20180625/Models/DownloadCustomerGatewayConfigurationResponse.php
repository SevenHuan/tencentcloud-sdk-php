 ...
 *
 * @method string getCustomerGatewayConfiguration() 获取配置信息。
 * @method void setCustomerGatewayConfiguration(string $CustomerGatewayConfiguration) 设置配置信息。
...
class DownloadCustomerGatewayConfigurationResponse extends AbstractModel
{
    ...
    /**
     * @param string $CustomerGatewayConfiguration 配置信息。
