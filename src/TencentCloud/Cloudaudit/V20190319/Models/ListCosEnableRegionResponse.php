 ...
 */
namespace Hdgtxcloud\Cloudaudit\V20190319\Models;
use TencentCloud\Common\AbstractModel;

/**
 * ListCosEnableRegion返回参数结构体
 *
 * @method array getEnableRegions() 获取云审计支持的cos可用区
 * @method void setEnableRegions(array $EnableRegions) 设置云审计支持的cos可用区
...
class ListCosEnableRegionResponse extends AbstractModel
{
    ...
    /**
     * @param array $EnableRegions 云审计支持的cos可用区
