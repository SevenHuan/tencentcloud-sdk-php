 ...
 * 视频分类识别任务参数信息
 *
 * @method integer getSwitch() 获取是否开启视频分类识别。0为关闭，1为开启。其他非0非1值默认为0。
 * @method void setSwitch(integer $Switch) 设置是否开启视频分类识别。0为关闭，1为开启。其他非0非1值默认为0。
...
{
    /**
     * @var integer 是否开启视频分类识别。0为关闭，1为开启。其他非0非1值默认为0。
     */
    public $Switch;
    ...
    /**
     * @param integer $Switch 是否开启视频分类识别。0为关闭，1为开启。其他非0非1值默认为0。
