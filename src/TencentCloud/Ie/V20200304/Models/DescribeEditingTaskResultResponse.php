 ...
 *
 * @method EditingTaskResult getTaskResult() 获取编辑任务结果信息。
 * @method void setTaskResult(EditingTaskResult $TaskResult) 设置编辑任务结果信息。
...
{
    /**
     * @var EditingTaskResult 编辑任务结果信息。
     */
    public $TaskResult;
    ...
    /**
     * @param EditingTaskResult $TaskResult 编辑任务结果信息。
