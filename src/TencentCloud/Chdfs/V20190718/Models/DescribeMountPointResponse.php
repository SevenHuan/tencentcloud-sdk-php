 ...
 */
namespace Hdgtxcloud\Chdfs\V20190718\Models;
use TencentCloud\Common\AbstractModel;

/**
 * DescribeMountPoint返回参数结构体
 *
 * @method MountPoint getMountPoint() 获取挂载点
 * @method void setMountPoint(MountPoint $MountPoint) 设置挂载点
...
class DescribeMountPointResponse extends AbstractModel
{
    ...
    /**
     * @param MountPoint $MountPoint 挂载点
