 ...
 *
 * @method string getPlaintext() 获取生成的随机数的明文，该明文使用base64编码，用户需要使用base64解码得到明文。
 * @method void setPlaintext(string $Plaintext) 设置生成的随机数的明文，该明文使用base64编码，用户需要使用base64解码得到明文。
...
{
    /**
     * @var string 生成的随机数的明文，该明文使用base64编码，用户需要使用base64解码得到明文。
     */
    public $Plaintext;
