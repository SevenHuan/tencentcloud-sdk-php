 ...
 * 自定义响应头配置，默认为关闭状态
 *
 * @method string getSwitch() 获取自定义响应头开关
on：开启
off：关闭
 * @method void setSwitch(string $Switch) 设置自定义响应头开关
on：开启
off：关闭
 * @method array getHeaderRules() 获取自定义响应头规则
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setHeaderRules(array $HeaderRules) 设置自定义响应头规则
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param string $Switch 自定义响应头开关
on：开启
off：关闭
     * @param array $HeaderRules 自定义响应头规则
注意：此字段可能返回 null，表示取不到有效值。
     */
