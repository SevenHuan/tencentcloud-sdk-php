 ...
 *
 * @method array getServices() 获取服务列表
 * @method void setServices(array $Services) 设置服务列表
 * @method integer getTotalCount() 获取服务总数
 * @method void setTotalCount(integer $TotalCount) 设置服务总数
