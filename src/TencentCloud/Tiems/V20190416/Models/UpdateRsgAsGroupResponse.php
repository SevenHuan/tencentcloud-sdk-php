 ...
 *
 * @method RsgAsGroup getRsgAsGroup() 获取资源组的伸缩组
 * @method void setRsgAsGroup(RsgAsGroup $RsgAsGroup) 设置资源组的伸缩组
...
class UpdateRsgAsGroupResponse extends AbstractModel
{
    ...
    /**
     * @param RsgAsGroup $RsgAsGroup 资源组的伸缩组
