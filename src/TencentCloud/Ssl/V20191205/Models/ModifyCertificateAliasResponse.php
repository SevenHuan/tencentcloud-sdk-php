 ...
 *
 * @method string getCertificateId() 获取修改成功的证书 ID。
 * @method void setCertificateId(string $CertificateId) 设置修改成功的证书 ID。
...
class ModifyCertificateAliasResponse extends AbstractModel
{
    ...
    /**
     * @param string $CertificateId 修改成功的证书 ID。
