 ...
 *
 * @method string getType() 获取人体朝向信息，返回值为以下集合中的一个 {正向, 背向, 左, 右}。
 * @method void setType(string $Type) 设置人体朝向信息，返回值为以下集合中的一个 {正向, 背向, 左, 右}。
...
{
    /**
     * @var string 人体朝向信息，返回值为以下集合中的一个 {正向, 背向, 左, 右}。
     */
    public $Type;
    ...
    /**
     * @param string $Type 人体朝向信息，返回值为以下集合中的一个 {正向, 背向, 左, 右}。
