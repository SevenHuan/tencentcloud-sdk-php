 ...
 *
 * @method string getType() 获取人体年龄信息，返回值为以下集合中的一个{小孩,青年,中年,老年}。
 * @method void setType(string $Type) 设置人体年龄信息，返回值为以下集合中的一个{小孩,青年,中年,老年}。
...
{
    /**
     * @var string 人体年龄信息，返回值为以下集合中的一个{小孩,青年,中年,老年}。
     */
    public $Type;
    ...
    /**
     * @param string $Type 人体年龄信息，返回值为以下集合中的一个{小孩,青年,中年,老年}。
