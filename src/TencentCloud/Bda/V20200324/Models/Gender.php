 ...
 *
 * @method string getType() 获取性别信息，返回值为以下集合中的一个 {男性, 女性}
 * @method void setType(string $Type) 设置性别信息，返回值为以下集合中的一个 {男性, 女性}
...
{
    /**
     * @var string 性别信息，返回值为以下集合中的一个 {男性, 女性}
     */
    public $Type;
    ...
    /**
     * @param string $Type 性别信息，返回值为以下集合中的一个 {男性, 女性}
