 ...
 * 下衣长度信息
 *
 * @method string getType() 获取下衣长度信息，返回值为以下集合中的一个，{长, 短} 。
 * @method void setType(string $Type) 设置下衣长度信息，返回值为以下集合中的一个，{长, 短} 。
...
{
    /**
     * @var string 下衣长度信息，返回值为以下集合中的一个，{长, 短} 。
     */
    public $Type;
    ...
    /**
     * @param string $Type 下衣长度信息，返回值为以下集合中的一个，{长, 短} 。
