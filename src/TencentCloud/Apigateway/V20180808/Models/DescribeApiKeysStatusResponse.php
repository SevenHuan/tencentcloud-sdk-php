 ...
 *
 * @method ApiKeysStatus getResult() 获取密钥列表。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(ApiKeysStatus $Result) 设置密钥列表。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param ApiKeysStatus $Result 密钥列表。
注意：此字段可能返回 null，表示取不到有效值。
