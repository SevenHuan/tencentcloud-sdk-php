 ...
 *
 * @method boolean getResult() 获取解绑自定义域名操作是否成功。
 * @method void setResult(boolean $Result) 设置解绑自定义域名操作是否成功。
...
class UnBindSubDomainResponse extends AbstractModel
{
    ...
    /**
     * @param boolean $Result 解绑自定义域名操作是否成功。
