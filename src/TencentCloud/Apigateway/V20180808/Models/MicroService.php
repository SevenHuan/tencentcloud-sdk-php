 ...
 * API绑定的微服务信息。
 *
 * @method string getClusterId() 获取微服务集群ID。
 * @method void setClusterId(string $ClusterId) 设置微服务集群ID。
 * @method string getNamespaceId() 获取微服务命名空间ID。
 * @method void setNamespaceId(string $NamespaceId) 设置微服务命名空间ID。
...
class MicroService extends AbstractModel
{
    ...
    /**
     * @param string $ClusterId 微服务集群ID。
     * @param string $NamespaceId 微服务命名空间ID。
