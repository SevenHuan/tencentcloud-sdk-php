 ...
 *
 * @method string getUsagePlanId() 获取待删除的使用计划唯一 ID。
 * @method void setUsagePlanId(string $UsagePlanId) 设置待删除的使用计划唯一 ID。
 */
class DeleteUsagePlanRequest extends AbstractModel
{
    /**
     * @var string 待删除的使用计划唯一 ID。
     */
    public $UsagePlanId;

    /**
     * @param string $UsagePlanId 待删除的使用计划唯一 ID。
     */
