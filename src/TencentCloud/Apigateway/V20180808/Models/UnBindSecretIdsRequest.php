 ...
 *
 * @method string getUsagePlanId() 获取待解绑的使用计划唯一 ID。
 * @method void setUsagePlanId(string $UsagePlanId) 设置待解绑的使用计划唯一 ID。
 * @method array getAccessKeyIds() 获取待解绑的密钥 ID 数组。
 * @method void setAccessKeyIds(array $AccessKeyIds) 设置待解绑的密钥 ID 数组。
 */
class UnBindSecretIdsRequest extends AbstractModel
{
    /**
     * @var string 待解绑的使用计划唯一 ID。
     */
    public $UsagePlanId;

    /**
     * @var array 待解绑的密钥 ID 数组。
     */
    public $AccessKeyIds;

    /**
     * @param string $UsagePlanId 待解绑的使用计划唯一 ID。
     * @param array $AccessKeyIds 待解绑的密钥 ID 数组。
     */
