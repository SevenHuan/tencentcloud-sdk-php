 ...
 *
 * @method string getUsagePlanId() 获取绑定的使用计划唯一 ID。
 * @method void setUsagePlanId(string $UsagePlanId) 设置绑定的使用计划唯一 ID。
...
class DescribeUsagePlanSecretIdsRequest extends AbstractModel
{
    ...
    /**
     * @param string $UsagePlanId 绑定的使用计划唯一 ID。
