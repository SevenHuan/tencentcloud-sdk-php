 ...
 * EnableApiKey请求参数结构体
 *
 * @method string getAccessKeyId() 获取待启用的密钥 ID。
 * @method void setAccessKeyId(string $AccessKeyId) 设置待启用的密钥 ID。
 */
class EnableApiKeyRequest extends AbstractModel
{
    /**
     * @var string 待启用的密钥 ID。
     */
    public $AccessKeyId;

    /**
     * @param string $AccessKeyId 待启用的密钥 ID。
     */
