 ...
 *
 * @method array getLoginStatusInfoSet() 获取用户登录状态列表。
 * @method void setLoginStatusInfoSet(array $LoginStatusInfoSet) 设置用户登录状态列表。
...
class DescribeLoginStatusResponse extends AbstractModel
{
    ...
    /**
     * @param array $LoginStatusInfoSet 用户登录状态列表。
