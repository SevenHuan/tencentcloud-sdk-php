 ...
 * @method array getTaskBaseInfoSet() 获取任务基础信息列表。
 * @method void setTaskBaseInfoSet(array $TaskBaseInfoSet) 设置任务基础信息列表。
...
class DescribeTasksResponse extends AbstractModel
{
     ...
     * @param array $TaskBaseInfoSet 任务基础信息列表。
