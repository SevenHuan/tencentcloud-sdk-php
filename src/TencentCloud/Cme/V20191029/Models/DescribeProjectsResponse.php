 ...
 * @method array getProjectInfoSet() 获取项目信息列表。
 * @method void setProjectInfoSet(array $ProjectInfoSet) 设置项目信息列表。
...
class DescribeProjectsResponse extends AbstractModel
{
     ...
     * @param array $ProjectInfoSet 项目信息列表。
