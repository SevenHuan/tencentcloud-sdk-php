 ...
 * @method string getClassPath() 获取素材分类路径，例如填写"/a/b"，则代表浏览该分类路径下的素材和子分类信息。
 * @method void setClassPath(string $ClassPath) 设置素材分类路径，例如填写"/a/b"，则代表浏览该分类路径下的素材和子分类信息。
 * @method Entity getOwner() 获取素材和分类的归属者。
 * @method void setOwner(Entity $Owner) 设置素材和分类的归属者。
...
class ListMediaRequest extends AbstractModel
{
    ...
    /**
     * @var string 素材分类路径，例如填写"/a/b"，则代表浏览该分类路径下的素材和子分类信息。
     */
    public $ClassPath;

    /**
     * @var Entity 素材和分类的归属者。
     */
    public $Owner;
     ...
     * @param string $ClassPath 素材分类路径，例如填写"/a/b"，则代表浏览该分类路径下的素材和子分类信息。
     * @param Entity $Owner 素材和分类的归属者。
