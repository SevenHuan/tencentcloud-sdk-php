 ...
 * @method array getSelectedTables() 获取待创建分布式索引表格列表
 * @method void setSelectedTables(array $SelectedTables) 设置待创建分布式索引表格列表
 */
class SetTableIndexRequest extends AbstractModel
{
    ...
    /**
     * @var array 待创建分布式索引表格列表
     */
    public $SelectedTables;

    /**
     * @param string $ClusterId 表所属集群实例ID
     * @param array $SelectedTables 待创建分布式索引表格列表
     */
