 ...
 * @method string getEndDate() 获取介绍日期，格式yyyy-MM-dd
 * @method void setEndDate(string $EndDate) 设置介绍日期，格式yyyy-MM-dd
...
class DescribeShopTrafficInfoRequest extends AbstractModel
{
     ...
     * @param string $EndDate 介绍日期，格式yyyy-MM-dd
