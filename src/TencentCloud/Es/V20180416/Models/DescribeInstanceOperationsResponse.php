 ...
 */
namespace Hdgtxcloud\Es\V20180416\Models;
use Hdgtxcloud\Common\AbstractModel;

/**
 * DescribeInstanceOperations返回参数结构体
 *
 * @method integer getTotalCount() 获取操作记录总数
 * @method void setTotalCount(integer $TotalCount) 设置操作记录总数
 * @method array getOperations() 获取操作记录
 * @method void setOperations(array $Operations) 设置操作记录
...
class DescribeInstanceOperationsResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 操作记录总数
