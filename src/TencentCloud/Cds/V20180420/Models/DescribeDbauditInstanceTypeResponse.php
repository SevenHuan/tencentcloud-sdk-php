 ...
 *
 * @method array getDbauditTypesSet() 获取数据安全审计产品规格信息列表
 * @method void setDbauditTypesSet(array $DbauditTypesSet) 设置数据安全审计产品规格信息列表
...
{
    /**
     * @var array 数据安全审计产品规格信息列表
     */
    public $DbauditTypesSet;
    ...
    /**
     * @param array $DbauditTypesSet 数据安全审计产品规格信息列表
