 ...
 *
 * @method array getEnvironmentIds() 获取成功删除的环境（命名空间）数组。
 * @method void setEnvironmentIds(array $EnvironmentIds) 设置成功删除的环境（命名空间）数组。
...
class DeleteEnvironmentsResponse extends AbstractModel
{
    ...
    /**
     * @param array $EnvironmentIds 成功删除的环境（命名空间）数组。
