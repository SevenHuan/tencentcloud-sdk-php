 ...
 *
 * @method array getTopicSets() 获取主题集合数组。
 * @method void setTopicSets(array $TopicSets) 设置主题集合数组。
 * @method integer getTotalCount() 获取主题数量。
 * @method void setTotalCount(integer $TotalCount) 设置主题数量。
...
class DescribeTopicsResponse extends AbstractModel
{
    ...
    /**
     * @param array $TopicSets 主题集合数组。
     * @param integer $TotalCount 主题数量。
