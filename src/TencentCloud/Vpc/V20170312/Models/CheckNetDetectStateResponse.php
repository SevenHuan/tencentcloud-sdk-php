 ...
 *
 * @method array getNetDetectIpStateSet() 获取网络探测验证结果对象数组。
 * @method void setNetDetectIpStateSet(array $NetDetectIpStateSet) 设置网络探测验证结果对象数组。
...
class CheckNetDetectStateResponse extends AbstractModel
{
    ...
    /**
     * @param array $NetDetectIpStateSet 网络探测验证结果对象数组。
