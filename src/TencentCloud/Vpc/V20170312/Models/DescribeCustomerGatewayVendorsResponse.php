 ...
 *
 * @method array getCustomerGatewayVendorSet() 获取对端网关厂商信息对象。
 * @method void setCustomerGatewayVendorSet(array $CustomerGatewayVendorSet) 设置对端网关厂商信息对象。
...
{
    /**
     * @var array 对端网关厂商信息对象。
     */
    public $CustomerGatewayVendorSet;
    ...
    /**
     * @param array $CustomerGatewayVendorSet 对端网关厂商信息对象。
