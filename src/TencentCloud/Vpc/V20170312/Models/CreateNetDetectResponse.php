 ...
 *
 * @method NetDetect getNetDetect() 获取网络探测（NetDetect）对象。
 * @method void setNetDetect(NetDetect $NetDetect) 设置网络探测（NetDetect）对象。
...
{
    /**
     * @var NetDetect 网络探测（NetDetect）对象。
     */
    public $NetDetect;
    ...
    /**
     * @param NetDetect $NetDetect 网络探测（NetDetect）对象。
